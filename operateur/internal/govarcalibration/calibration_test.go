...
func TestGoldenArtifactIsOrderIndependentAndReproducible(t *testing.T) {
	...
	if a.UpperOutputTokens != 4 || a.Support != 5 || a.EmpiricalCoveragePPB != 800_000_000 {
	...
	const golden = "ec775220ae00bb6dd7419056f82d49962c4b252053a11c67e9333933c178bd15"
...
func TestCalibrationRejectsLeakageAndNonFinalInputs(t *testing.T) {
	...
	if _, err := BuildArtifact(testConfig(), rows(SplitDevelopment, 1, 2)); err != nil {
		t.Fatalf("eligible development observations rejected: %v", err)
	}
}
