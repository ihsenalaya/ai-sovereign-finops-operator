...
- L'image `ghcr.io/ihsenalaya/ai-sovereign-finops-operator/controller:0.5.11` publiée sur GHCR.
- L'image `ghcr.io/ihsenalaya/ai-sovereign-finops-grafana-radar:11.2.2-echarts6.6.0` publiée sur GHCR pour le radar Grafana.
...
`./demo.sh up` enchaîne :
1. **Opérateur** — vérifie/installe le déploiement (Helm, image 0.5.11).
