...
```bash
make docker-build IMG=ghcr.io/ihsenalaya/ai-sovereign-finops-operator:0.4.0
kind load docker-image ghcr.io/ihsenalaya/ai-sovereign-finops-operator:0.4.0 --name greenops
make deploy IMG=ghcr.io/ihsenalaya/ai-sovereign-finops-operator:0.4.0
# ou via Helm :
