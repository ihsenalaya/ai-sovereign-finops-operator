...
- Run started: 2026-06-06T16:17:30Z
- Last update: 2026-06-06T16:21:31Z
- Totals: **42 PASS**, **0 FAIL**, 42 total

| # | Group | Test | Status | Duration | Details |
|--:|-------|------|:------:|---------:|---------|
| 1 | RQ1-3-matrix | B1-premium-static / W1-HR-Chatbot | PASS | 4988ms | {"blocked":0,"costEUR":0.015415,"meanQuality1to5":4.5,"served":10} |
| 2 | RQ1-3-matrix | B1-premium-static / W2-RAG-Docs | PASS | 5130ms | {"blocked":0,"costEUR":0.003018,"meanQuality1to5":5,"served":10} |
| 3 | RQ1-3-matrix | B1-premium-static / W3-Dev-Assistant | PASS | 5409ms | {"blocked":0,"costEUR":0.012403,"meanQuality1to5":4.7,"served":10} |
| 4 | RQ1-3-matrix | B1-premium-static / W4-Analytical-Agent | PASS | 4128ms | {"blocked":0,"costEUR":0.008095,"meanQuality1to5":4.2,"served":10} |
| 5 | RQ1-3-matrix | B2-round-robin / W1-HR-Chatbot | PASS | 11843ms | {"blocked":0,"costEUR":0.002898,"meanQuality1to5":4.092,"served":10} |
| 6 | RQ1-3-matrix | B2-round-robin / W2-RAG-Docs | PASS | 9552ms | {"blocked":0,"costEUR":0.001698,"meanQuality1to5":5,"served":10} |
| 7 | RQ1-3-matrix | B2-round-robin / W3-Dev-Assistant | PASS | 17593ms | {"blocked":0,"costEUR":0.003972,"meanQuality1to5":4.9,"served":10} |
| 8 | RQ1-3-matrix | B2-round-robin / W4-Analytical-Agent | PASS | 8004ms | {"blocked":0,"costEUR":0.001607,"meanQuality1to5":4.288,"served":10} |
| 9 | RQ1-3-matrix | B3-least-cost / W1-HR-Chatbot | PASS | 0ms | {"blocked":0,"costEUR":0.000055,"meanQuality1to5":3.96,"served":10} |
| 10 | RQ1-3-matrix | B3-least-cost / W2-RAG-Docs | PASS | 10142ms | {"blocked":0,"costEUR":0.000117,"meanQuality1to5":5,"served":10} |
| 11 | RQ1-3-matrix | B3-least-cost / W3-Dev-Assistant | PASS | 16081ms | {"blocked":0,"costEUR":0.000472,"meanQuality1to5":4.8,"served":10} |
| 12 | RQ1-3-matrix | B3-least-cost / W4-Analytical-Agent | PASS | 0ms | {"blocked":0,"costEUR":0.000056,"meanQuality1to5":3.96,"served":10} |
| 13 | RQ1-3-matrix | B4-static-policy / W1-HR-Chatbot | PASS | 16542ms | {"blocked":0,"costEUR":0.000331,"meanQuality1to5":4,"served":10} |
| 14 | RQ1-3-matrix | B4-static-policy / W2-RAG-Docs | PASS | 17393ms | {"blocked":0,"costEUR":0.000182,"meanQuality1to5":5,"served":10} |
...
| 21 | RQ1-3-matrix | B6-ours / W1-HR-Chatbot | PASS | 28894ms | {"blocked":0,"costEUR":0.000717,"meanQuality1to5":4.3,"served":10} |
| 22 | RQ1-3-matrix | B6-ours / W2-RAG-Docs | PASS | 0ms | {"blocked":0,"costEUR":0.000182,"meanQuality1to5":5,"served":10} |
| 23 | RQ1-3-matrix | B6-ours / W3-Dev-Assistant | PASS | 0ms | {"blocked":0,"costEUR":0.012403,"meanQuality1to5":4.7,"served":10} |
| 24 | RQ1-3-matrix | B6-ours / W4-Analytical-Agent | PASS | 22801ms | {"blocked":0,"costEUR":0.000497,"meanQuality1to5":4.4,"served":10} |
...
| 26 | RQ4-sovereignty | global / B6-ours | PASS | 0ms | {"blocked":0,"costEUR":0.013798,"meanQualityNorm":0.9,"reroutes":30,"served":40,"violations":0} |
...
| 28 | RQ4-sovereignty | eu-only / B6-ours | PASS | 0ms | {"blocked":20,"costEUR":0.00011,"meanQualityNorm":0.74,"reroutes":20,"served":20,"violations":0} |
...
| 32 | RQ4-sovereignty | no-external-sensitive / B6-ours | PASS | 0ms | {"blocked":0,"costEUR":0.013136,"meanQualityNorm":0.87875,"reroutes":30,"served":40,"violations":0} |
...
| 39 | RQ-ablation | full-system | PASS | 0ms | {"costEUR":0.013798,"meanQualityNorm":0.9} |
| 40 | RQ-ablation | no-cost-term | PASS | 0ms | {"costEUR":0.03893,"meanQualityNorm":0.9} |
| 41 | RQ-ablation | no-quality-term | PASS | 12194ms | {"costEUR":0.001213,"meanQualityNorm":0.8625} |
| 42 | RQ-ablation | no-latency-term | PASS | 0ms | {"costEUR":0.013798,"meanQualityNorm":0.9} |
